...
import website.eccentric.tome.client.gui.ForgeRenderGameOverlayHandler;
...
public class EccentricTome {
    ...
    private void onClientSetup(final FMLClientSetupEvent event) {
        MinecraftForge.EVENT_BUS.addListener(EventPriority.LOW, ForgeRenderGameOverlayHandler::onRender);
